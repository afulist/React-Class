...
const App = React.createClass({
	getInitialState() {
		return { data: [{
		    ...
		    "isActive": true,
		    "price": "$2,898.86",
		    "picture": "http://lorempixel.com/output/cats-h-c-200-300-2.jpg",
		    "name": "Melody Strong",
		    ...
		    "isActive": false,
		    "price": "$3,935.09",
		    "picture": "http://lorempixel.com/output/cats-h-c-200-300-3.jpg",
		    ...
		    "isActive": false,
		    "price": "$2,272.78",
		    "picture": "http://lorempixel.com/output/cats-h-c-200-300-4.jpg",
		    "name": "Pearl Whitley",
		    ...
		    "isActive": true,
		    "price": "$3,951.16",
		    "picture": "http://lorempixel.com/output/cats-h-c-200-300-5.jpg",
